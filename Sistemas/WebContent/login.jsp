...
<body>
 ...
 <div class="container">
        <div class="card card-container">
            ...
            <img id="profile-img" class="profile-img-card" src="/Sistemas/Images/login.png" />
            <p id="profile-name" class="profile-name-card"></p>
            <form class="form-signin"  action="Login" method="POST">
                <span id="reauth-email" class="reauth-email"></span>
                <input type="text" id="usuario" name="usuario" class="form-control" placeholder="User" required autofocus >
 ...
 <% 
   ...
   if(request.getParameter("cerrar") !=null){
	...
	// sesion.setAttribute("sesion", "sesion cerrada");
